...
public:         
        ...
        */
         ...
         */
        Eigen::VectorXd integrateState(const Eigen::VectorXd& x, const Eigen::VectorXd& control, const double& integration_time) const {
        ...
        //  */
        // void controlToQueue(const Eigen::VectorXd& u, const double& timestamp, const bool& isThrusterVector){
        ...
        //  */
        // Eigen::VectorXd preIntegrateState(const Eigen::VectorXd& x, const double start_time, const double end_time) {
        //         if(control_queue_.empty()) {
        //                 return x;
        //         }
